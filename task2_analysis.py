#!/usr/bin/env python3
"""
Task 2: Email Security Classification Analysis - Records 101-200
"""

import csv
import sys

# Reuse the same analysis function from Task 1
...
def main():
    ...
    print("Senior Security Analyst - Task 2: Records 101-200")
    print("-" * 50)
    
    # Process second batch (rows 101-200, accounting for header)
    batch_results = process_batch(filename, 100, 200)
    ...
    print("Sample Results (First 20 records of this batch):")
